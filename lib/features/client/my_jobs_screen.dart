// lib/features/client/screens/my_jobs_screen.dart
...
class _MyJobsScreenState extends ConsumerState<MyJobsScreen> {
  String _clientId = '';
  String _selectedFilter = 'all'; // all, open, in-progress, completed
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // 🔥 FIXED: Using Consumer to get bid count
                      Consumer(
