              ...
              child: FilterChip(
                label: Text(filter,
                    style: TextStyle(
                      ...
                      color: isSelected
                          ? Colors.white
                          : (isDark ? Colors.white : CColors.textPrimary),
                    )),
                selected: isSelected,
                onSelected: (selected) {
                  if (selected) {
          ...
          children: [
            ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                // 🟢 Each card watches its own bid count stream
      ...
      child: Card(
        ...
        child: Column(
          ...
          children: [
            Container(
              padding: const EdgeInsets.symmetric(
                  horizontal: CSizes.md, vertical: 12),
              decoration: BoxDecoration(
                gradient: _getHeaderGradient(job),
              ),
              child: Row(
                children: [
                  Expanded(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      bidCountAsync.when(
                        data: (count) =>
                            _buildBidCount(context, isUrdu, count),
                        loading: () =>
